...
-- AddForeignKey
ALTER TABLE `comments` ADD CONSTRAINT `comments_news_listId_fkey` FOREIGN KEY (`news_listId`) REFERENCES `news_list`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
